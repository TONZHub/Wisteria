...
class RecordSingleInputCheckInTool(
    ...
    override val parametersSchema: String = "{ inputVal: String, rating: Int, detectedTexture: String, confidence: Float, agentAcknowledgment: String }"
    ...
    override suspend fun execute(parameters: Map<String, String>): ToolExecutionResult {
        ...
        val pulse = DailyPulseData(
            ...
            agentAcknowledgment = parameters["agentAcknowledgment"] ?: if (needsSupport)
